...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var messageArray = [addition, multiplication, a + ' and ' + b + ' and ' + c + ' sum to ' + addition + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplication + '.'];
  return messageArray;
}
...
var calc = sum(testArray[0], sum(testArray[1], testArray[2])[0])[0];
var messageFour = testArray + ' was passed in as an array of numbers, and ' + calc + ' is their sum.';
var outputMessage = [calc, messageFour];
...
function multiplyArray(testArray) { //eslint-disable-line
  var calc = multiply(testArray[0], multiply(testArray[1], testArray[2])[0])[0];
  var messageFour = 'The numbers ' + testArray + ' have a product of ' + calc + '.';
  var outputMessage = [calc, messageFour];
  return outputMessage;
}
